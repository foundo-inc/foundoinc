    ...
    <div className="container mx-auto px-4">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {testimonials.map((t, i) => (
          <div key={i} className="group p-5 rounded-xl border border-border bg-card hover:border-primary/20 hover:shadow-md hover:shadow-primary/[0.03] transition-all duration-300">
            <div className="flex items-center gap-2.5 mb-3">
              <div className={`h-9 w-9 rounded-full ${t.color} flex items-center justify-center text-primary-foreground font-bold text-xs`}>
                {t.avatar}
              </div>
              <div>
            ...
            <p className="text-foreground text-xs leading-relaxed mb-3">{t.text}</p>
