  ...
  <section className="py-20 md:py-28 bg-muted/30 relative">
    <div className="container mx-auto px-4">
      ...
      <div className="grid md:grid-cols-3 gap-4 max-w-3xl mx-auto">
        {promises.map((p, i) => (
          <div key={i} className="group text-center p-6 rounded-2xl border border-border bg-card hover:border-primary/20 hover:shadow-md hover:shadow-primary/[0.03] transition-all duration-300">
            <div className="h-12 w-12 rounded-xl bg-primary/[0.08] flex items-center justify-center mx-auto mb-4 group-hover:bg-primary/[0.12] group-hover:scale-110 transition-all duration-300">
              <p.icon className="h-6 w-6 text-primary" />
            </div>
            <h3 className="font-bold text-sm mb-2 font-display">{p.title}</h3>
