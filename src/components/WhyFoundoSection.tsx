...
const WhyFoundoSection = () => (
  <section id="why-foundo" className="py-20 md:py-28 bg-background relative">
    <div className="container mx-auto px-4">
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
        {/* Left Side */}
        <div className="lg:sticky lg:top-28">
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-primary mb-3">Why Foundo</p>
          ...
          <Button size="lg" className="rounded-full shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/25 transition-all duration-300 hover:-translate-y-0.5 h-12 px-7 text-sm font-semibold">
        ...
        <div className="space-y-3">
          {benefits.map((b, i) => (
            <div key={i} className="group flex items-start gap-4 p-5 rounded-xl border border-border bg-card hover:border-primary/20 hover:shadow-md hover:shadow-primary/[0.03] transition-all duration-300">
              ...
              <div>
                <h3 className="font-bold text-sm mb-0.5 font-display">{b.title}</h3>
