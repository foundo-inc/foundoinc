...
const footerLinks: Record<string, { label: string; href: string }[]> = {
  ...
  Services: [
    { label: "LLC Formation", href: "/dashboard" },
    { label: "Registered Agent", href: "/dashboard" },
    { label: "EIN Application", href: "/dashboard" },
    { label: "Operating Agreement", href: "/dashboard" },
  ],
  Addons: [
    { label: "ITIN Processing", href: "/dashboard" },
    { label: "Seller Permit", href: "/dashboard" },
    { label: "Amendment", href: "/dashboard" },
    { label: "Dissolution", href: "/dashboard" },
  ],
  Legal: [
