...
const footerLinks: Record<string, { label: string; href: string }[]> = {
  ...
  Services: [
    { label: "LLC Formation", href: "/checkout" },
    { label: "Registered Agent", href: "/checkout" },
    { label: "EIN Application", href: "/checkout" },
    { label: "Operating Agreement", href: "/checkout" },
  ],
  Addons: [
    { label: "ITIN Processing", href: "/checkout" },
    { label: "Seller Permit", href: "/checkout" },
    { label: "Amendment", href: "/checkout" },
    { label: "Dissolution", href: "/checkout" },
  ],
  Legal: [
